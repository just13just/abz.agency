                ...
                <div className='about-me__container'>
                    <div>
                        ...
                        <div className='about-me__description'>
                            <div className='about-me__description_desktop'> We kindly remind you that your test assignment should be submitted as a link to github/bitbucket repository.
